    ...
    <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-32">
        ...
        <div class="flex items-stretch justify-center">
            <div class="grid grid-cols-1 lg:grid-cols-2 justify-between">
                    ...
                    <ul class="mb-6 md:mb-0">
                        ...
                        <li class="flex">
                            ...
                            <div class="ml-4 mb-4">
                                ...
                                <p class="text-gray-600 dark:text-slate-400">Mobile: +91 9988776655</p>
                                <p class="text-gray-600 dark:text-slate-400">Mail: info@Sunshineturf.com</p>
                            </div>
                        </li>
                        <li class="flex">
                            <div class="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
                ...
                <div class="w-full p-5 md:p-12" id="form">
                    <h2 class="mb-4 text-2xl font-bold ">
                      Send us your Queries or Feedback</h2>
                    <form id="contactForm">
                        <div class="mb-6">
                        ...
                        <div class="text-center">
                            <button type="submit" class="w-full bg-gray text-lite-green px-6 py-3 font-xl rounded-md sm:mb-0">Send Message</button>
                        </div>
                    </form>
                </div>
            </div>
